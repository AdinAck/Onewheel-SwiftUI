...
enum BalanceState: UInt16 {
    case STARTUP                       = 0,
         ...
         FAULT_DUTY                    = 10,
         FAULT_STARTUP                 = 11,
         FAULT_UNKNOWN                 = 12, // i presume this is possible but don't know what it means
         FAULT_QUICKSTOP               = 13  // this is a guess
}

enum SwitchState: UInt16 {
    case OFF = 0,
         HALF,
         ON
}
